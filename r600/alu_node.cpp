...
const AluOP alu_ops[] = {
   ...
   {OP2_NOP,                 0, a},
   {OP2_MUL_64,              2, a},
   {OP2_FLT64_TO_FLT32,      1, a},
   {OP2V_FLT32_TO_FLT64,     1, a},
   {OP2_PRED_SETGT_UINT,     2, a},
   {OP2_PRED_SETGE_UINT,     2, a},
   {OP2_PRED_SETE,           2, a},
   {OP2_PRED_SETGT,          2, a},
   {OP2_PRED_SETGE,          2, a},
   {OP2_PRED_SETNE,          2, a},
   {OP2_PRED_SET_INV,        1, a},
   {OP2_PRED_SET_POP,        2, a},
   {OP2_PRED_SET_CLR,        0, a},
   {OP2_PRED_SET_RESTORE,    1, a},
   {OP2_PRED_SETE_PUSH,      2, a},
   {OP2_PRED_SETGT_PUSH,     2, a},
   {OP2_PRED_SETGE_PUSH,     2, a},
   {OP2_PRED_SETNE_PUSH,     2, a},
   {OP2_KILLE,               2, a},
   {OP2_KILLGT,              2, a},
   {OP2_KILLGE,              2, a},
   {OP2_KILLNE,              2, a},
   ...
   {OP2_KILLGE_UINT,         2, a},
   {OP2_PREDE_INT,           2, a},
   {OP2_PRED_SETGT_INT,      2, a},
   {OP2_PRED_SETGE_INT,      2, a},
   {OP2_PRED_SETNE_INT,      2, a},
   {OP2_KILLE_INT,           2, a},
   {OP2_KILLGT_INT,          2, a},
   {OP2_KILLGE_INT,          2, a},
   {OP2_KILLNE_INT,          2, a},
   {OP2_PRED_SETE_PUSH_INT,  2, a},
   {OP2_PRED_SETGT_PUSH_INT, 2, a},
   {OP2_PRED_SETGE_PUSH_INT, 2, a},
   {OP2_PRED_SETNE_PUSH_INT, 2, a},
   {OP2_PRED_SETLT_PUSH_INT, 2, a},
   {OP2_PRED_SETLE_PUSH_INT, 2, a},
   {OP2_FLT_TO_INT,          1, a},
   {OP2_BFREV_INT,           1, a},
   {OP2_ADDC_UINT,           2, a},
   {OP2_SUBB_UINT,           2, a},
   {OP2_GROUP_BARRIER,       0, a},
   {OP2_GROUP_SEQ_BEGIN,     0, a},
   {OP2_GROUP_SEQ_END,       0, a},
   {OP2_SET_MODE,            2, a},
   {OP2_SET_CF_IDX0,         1, a}, /* Reads from AR register? */
   {OP2_SET_CF_IDX1,         1, a}, /* Reads from AR register? */
   {OP2_SET_LDS_SIZE,        2, a},
   {OP2_EXP_IEEE,            1, t},
   {OP2_LOG_CLAMPED,         1, t},
   {OP2_LOG_IEEE,            1, t},
   {OP2_RECIP_CLAMPED,       1, t},
   {OP2_RECIP_FF,            1, t},
   {OP2_RECIP_IEEE,          1, t},
   {OP2_RECIPSQRT_CLAMPED,   1, t},
   {OP2_RECIPSQRT_FF,        1, t},
   {OP2_RECIPSQRT_IEEE,      1, t},
   {OP2_SQRT_IEEE,           1, t},
   {OP2_SIN,                 1, t},
   {OP2_COS,                 1, t},
   {OP2_MULLO_INT,           2, t},
   ...
   {OP2_RECIP_UINT,          1, t},
   {OP2_RECIP_64,            1, t},
   {OP2_RECIP_CLAMPED_64,    1, t},
   {OP2_RECIPSQRT_64,        1, t},
   {OP2_RECIPSQRT_CLAMPED_64,1, t},
   {OP2_SQRT_64,             1, t},
   {OP2_FLT_TO_UINT,         1, t},
   {OP2_INT_TO_FLT,          1,t},
   {OP2_UINT_TO_FLT,         1,t},
   {OP2_BFM_INT,             2,v},
   {OP2_FLT32_TO_FLT16,,v},
   {OP2_FLT16_TO_FLT32,,v},
   {OP2_UBYTE0_FLT,,v},
   {OP2_UBYTE1_FLT,,v},
   {OP2_UBYTE2_FLT,,v},
   {OP2_UBYTE3_FLT,,v},
   ...
   {OP2_FLT_TO_UINT4,,v},
   {OP2_DOT_IEEE,,v},
   {OP2_FLT_TO_INT_RPI,,v},
   {OP2_FLT_TO_INT_FLOOR,,v},
   {OP2_MULHI_UINT24,,v},
   {OP2_MBCNT_32HI_INT,,v},
   {OP2_OFFSET_TO_FLT,,v},
   {OP2_MUL_UINT24,,v},
   {OP2_BCNT_ACCUM_PREV_INT,,v},
   {OP2_MBCNT_32LO_ACCUM_PREV_INT,,v},
   {OP2_SETE_64,,v},
   {OP2_SETNE_64,,v},
   {OP2_SETGT_64,,v},
   {OP2_SETGE_64,,v},
   ...
   {OP2_ADD_64,,v},
   {OP2_MOVA_INT,,v},
   {OP2V_FLT64_TO_FLT32,,v},
   {OP2_FLT32_TO_FLT64,,v},
   {OP2_SAD_ACCUM_PREV_UINT,,v},
   {OP2_DOT,,v},
   {OP2_MUL_PREV,,v},
   {OP2_MUL_IEEE_PREV,,v},
   {OP2_ADD_PREV,,v},
   {OP2_MULADD_PREV,,v},
   {OP2_MULADD_IEEE_PREV,,v},
   {OP2_INTERP_XY,,v},
   {OP2_INTERP_ZW,,v},
   {OP2_INTERP_X,,v},
   {OP2_INTERP_Z,,v},
   {OP2_STORE_FLAGS,,v},
   {OP2_LOAD_STORE_FLAGS,,v},
   {OP2_LDS_1A,,v},
   {OP2_LDS_1A1D,,v},
   {OP2_LDS_2A,,v},
   {OP2_INTERP_LOAD_P0,,v},
   {OP2_INTERP_LOAD_P10,,v},
   {OP2_INTERP_LOAD_P20,,v},
   {OP3_INST_BFE_UINT, 3,v},
   {OP3_INST_BFE_INT, 3,v},
   {OP3_INST_BFI_INT, 3,v},
   {OP3_INST_FMA, 3,v},
   {OP3_INST_CNDNE_64, 3,v},
   {OP3_INST_FMA_64, 3,v},
   {OP3_INST_LERP_UINT, 3,v},
   {OP3_INST_BIT_ALIGN_INT, 3,v},
   {OP3_INST_BYTE_ALIGN_INT, 3,v},
   {OP3_INST_SAD_ACCUM_UINT, 3,v},
   {OP3_INST_SAD_ACCUM_HI_UINT, 3,v},
   {OP3_INST_MULADD_UINT24, 3,v},
   {OP3_INST_LDS_IDX_OP, 3,v},
   {OP3_INST_MULADD, 3,a},
   {OP3_INST_MULADD_M2, 3,a},
   {OP3_INST_MULADD_M4, 3,a},
   {OP3_INST_MULADD_D2, 3,a},
   {OP3_INST_MULADD_IEEE, 3,a},
   {OP3_INST_CNDE, 3,a},
   {OP3_INST_CNDGT, 3,a},
   {OP3_INST_CNDGE, 3,a},
   {OP3_INST_CNDE_INT, 3,a},
   {OP3_INST_CNDGT_INT, 3,a},
   {OP3_INST_CNDGE_INT, 3,a},
   {OP3_INST_MUL_LIT, 3,t},
};
