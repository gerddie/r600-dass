...
const std::map<EAluOp, AluOp> alu_ops = {
   ...
   {OP3_INST_BFE_UINT       ,AluOp(3, AluOp::v,"BFE_UINT")},
   {OP3_INST_BFE_INT        ,AluOp(3, AluOp::v,"BFE_INT")},
   {OP3_INST_BFI_INT        ,AluOp(3, AluOp::v,"BFI_INT")},
   {OP3_INST_FMA            ,AluOp(3, AluOp::v,"FMA")},
   {OP3_INST_CNDNE_64       ,AluOp(3, AluOp::v,"CNDNE_64")},
   {OP3_INST_FMA_64         ,AluOp(3, AluOp::v,"FMA_64")},
   {OP3_INST_LERP_UINT      ,AluOp(3, AluOp::v,"LERP_UINT")},
   {OP3_INST_BIT_ALIGN_INT  ,AluOp(3, AluOp::v,"BIT_ALIGN_INT")},
   {OP3_INST_BYTE_ALIGN_INT ,AluOp(3, AluOp::v,"BYTE_ALIGN_INT")},
   {OP3_INST_SAD_ACCUM_UINT ,AluOp(3, AluOp::v,"SAD_ACCUM_UINT")},
   {OP3_INST_SAD_ACCUM_HI_UINT ,AluOp(3, AluOp::v,"SAD_ACCUM_HI_UINT")},
   {OP3_INST_MULADD_UINT24  ,AluOp(3, AluOp::v,"MULADD_UINT24")},
   {OP3_INST_LDS_IDX_OP     ,AluOp(3, AluOp::x,"LDS_IDX_OP")},
   {OP3_INST_MULADD         ,AluOp(3, AluOp::a,"MULADD")},
   {OP3_INST_MULADD_M2      ,AluOp(3, AluOp::a,"MULADD_M2")},
   {OP3_INST_MULADD_M4      ,AluOp(3, AluOp::a,"MULADD_M4")},
   {OP3_INST_MULADD_D2      ,AluOp(3, AluOp::a,"MULADD_D2")},
   {OP3_INST_MULADD_IEEE    ,AluOp(3, AluOp::a,"MULADD_IEEE")},
   {OP3_INST_CNDE           ,AluOp(3, AluOp::a,"CNDE")},
   {OP3_INST_CNDGT          ,AluOp(3, AluOp::a,"CNDGT")},
   {OP3_INST_CNDGE          ,AluOp(3, AluOp::a,"CNDGE")},
   {OP3_INST_CNDE_INT       ,AluOp(3, AluOp::a,"CNDE_INT")},
   {OP3_INST_CNDGT_INT      ,AluOp(3, AluOp::a,"CNDGT_INT")},
   {OP3_INST_CNDGE_INT      ,AluOp(3, AluOp::a,"CNDGE_INT")},
   {OP3_INST_MUL_LIT        ,AluOp(3, AluOp::t,"MUL_LIT")}
};
